            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlChangePassword" runat="server" Visible="true">
                    ...
                    <fieldset>
                        ...
                        <Rock:RockTextBox ID="tbOldPassword" runat="server" Label="Old Password" Required="true" TextMode="Password" ValidateRequestMode="Disabled" autocomplete="current-password"></Rock:RockTextBox>
                        <Rock:RockTextBox ID="tbPassword" runat="server" Label="New Password" Required="true" TextMode="Password" ValidateRequestMode="Disabled" autocomplete="new-password"></Rock:RockTextBox>
                        <Rock:RockTextBox ID="tbPasswordConfirm" runat="server" Label="Confirm Password" Required="true" ValidateRequestMode="Disabled"  TextMode="Password" autocomplete="new-password"></Rock:RockTextBox>
